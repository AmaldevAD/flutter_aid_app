...
class CouncellorDetail extends StatefulWidget {
  CouncellorDetail({Key key}) : super(key: key);

  @override
  _CouncellorDetailState createState() => _CouncellorDetailState();
}

class _CouncellorDetailState extends State<CouncellorDetail> {
  @override
