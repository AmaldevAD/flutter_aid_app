      ...
      body: Column(
        children: <Widget>[
          new Stack(
            ...
            children: <Widget>[
              Image.network('https://upload.wikimedia.org/wikipedia/commons/thumb/6/64/Red_Ribbon.svg/1200px-Red_Ribbon.svg.png', width: MediaQuery.of(context).size.width/1.5,height: 150,),
              WavyHeader(),
            ],
          ),
          Expanded(
